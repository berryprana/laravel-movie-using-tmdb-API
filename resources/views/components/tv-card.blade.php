<div class="mt-8">
    <a href="{{ route('tv.show', $tv['id']) }}">
        <img src="{{ $tv['poster_path'] }}" alt="tv poster" class="hover:opacity-50 transition ease-in-out duration-150">
    </a>
    <div class="mt-2">
    <a href="{{ route('tv.show', $tv['id']) }}" class="text-lg-2 mt-2 hover:text-gray-300">{{ $tv['name'] }}</a>
        <div class="flex items-center text-gray-400 text-sm mt-1">
            ...
            <span class="mx-2">|</span>
            <span class="ml-1">{{ $tv['original_language'] }}</span>
        </div>
        <!--Genre -->
