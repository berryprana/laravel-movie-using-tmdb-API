...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-16 py-16 flex flex-col md:flex-row">
            <img src="{{ $movie['poster_path'] }}" alt="" class="w-64 md:w-96">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold mt-1">{{$movie['title']}}</h2>
            ...
            <!-- Start movie-cast -->
                ...
                <!--start movie image-->
                <div class="movie-image border-b border-gray-800" x-data="{ isOpen: false, images: ''}">
                    <div class="container mx-auto px-16 py-16">
